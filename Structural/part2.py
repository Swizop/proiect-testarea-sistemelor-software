...
class StructuralTests:
    ...
    def test_multiple_condition_coverage(self):
        ...
        studentWithGmailUnder15 = Student(name="John Doe",
                                          ...
                                          age=14)
        assert studentWithGmailUnder15.get_platform_username(
        ) == "johndoe@gmail.com"
        ...
        studentGmailUnder15ThreeNames = Student(name="John Doe Little",
                                                email="johndoe@gmail.com",
                                                age=14)
        assert studentGmailUnder15ThreeNames.get_platform_username(
        ) == "johndoe@gmail.com"
        ...
        studentGmail16TwoNames = Student(name="John Doe",
                                         email="johndoe@gmail.com",
                                         age=16)
        assert studentGmail16TwoNames.get_platform_username(
        ) == "johndoe@gmail.com"
        ...
        studentWithGmailOver15 = Student(name="John Doe",
                                         email="johndoe@gmail.com",
                                         age=20)
        assert studentWithGmailOver15.get_platform_username(
        ) == "johndoe@gmail.com"
        ...
        studentGmail16ThreeNames = Student(name="John Doe Matei",
                                           email="johndoe@gmail.com",
                                           age=16)
        assert studentGmail16ThreeNames.get_platform_username(
        ) == "johndoe@gmail.com"
        ...
        studentGmail20ThreeNames = Student(name="John Doe Matei",
                                           email="johndoe@gmail.com",
                                           age=20)
        assert studentGmail20ThreeNames.get_platform_username(
        ) == "johndoe@gmail.com"
        ...
        studentWithYahooUnder15 = Student(name="John Doe",
                                          ...
                                          age=14)
        assert studentWithYahooUnder15.get_platform_username(
        ) == "johndoe@yahoo.com"
        ...
        studentYahooThreeNamesUnder15 = Student(name="John Doe Matei",
                                                email="johndoe@yahoo.com",
                                                age=14)
        assert studentYahooThreeNamesUnder15.get_platform_username(
        ) == "johndoe@yahoo.com"
        ...
        yahooAdultStudentWithTwoNames = Student(name="John Connor",
                                                ...
                                                age=21)
        assert yahooAdultStudentWithTwoNames.get_platform_username(
        ) == "JohnConnor"
